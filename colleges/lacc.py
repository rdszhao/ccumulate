...
# the basics
period = 'Fall'
url = f'https://www.lacitycollege.edu/Academics/Classes/Open-Classes-{period}'
...
# use regex to compile classes into df-ready dictionary format
class_dict = {}
for section in soup:
